...
SETTINGS_DEFAULTS = {
    ...
    "tts_engine": ("TTS_ENGINE", "piper", "TTS engine (piper / edge)"),
    "tts_url": ("TTS_URL", "http://127.0.0.1:5150", "TTS HTTP URL (für piper und andere HTTP-Engines)"),
    "tts_voice": ("TTS_VOICE", "de_DE-thorsten-high", "TTS-Stimme (engine-abhängig)"),
